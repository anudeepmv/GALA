 ...
 */
chatRoomSchema.statics.initiateChat = async function (userIds, type, _id, chatInitiator) {
  try {
...
module.exports={ChatRoomModel: mongoose.model("ChatRoom", chatRoomSchema), CHAT_ROOM_TYPES};
